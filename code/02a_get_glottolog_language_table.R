...
if(!file.exists("data/processed_data/glottolog_5.0_languages.tsv")){
...
glottolog_rcldf_obj$tables$LanguageTable %>% 
  ...
  write_tsv("data/processed_data/glottolog_5.0_languages.tsv")
}

if(!file.exists("data/processed_data/glottolog_5.0_IE_tree.tree")){
...
tree_IE_full %>% 
  ape::write.tree("data/processed_data/glottolog_5.0_IE_tree.tree")
}